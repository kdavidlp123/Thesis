...
def main():
    ...
    for name in names:
        ...
        kpt_free_5_test_img = os.path.join(result, name, "5_test_img")

        
        imgs = os.listdir(kpt_free_5_test_img)
        ...
        for img in imgs:
            ...
            pred_instances = process_one_image(os.path.join(kpt_free_5_test_img, img), detector, pose_estimator)
