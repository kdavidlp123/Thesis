...
def main():
    ...
    for ear_type in ear_types:
        ...
        for name in names:
            if name == "cather" or name == "willy":
                save_model_path = os.path.join("k_fold", "model_save",ear_type, name)
                ...
                create_dataset(names_copy, training_kpt_img_path, training_kpt_json_path, root_eartype, degrees, ear_type,use_bbox = False, dataset_type = "training")


                test_kpt_img_path = os.path.join(root_eartype, "5_test_img")
                test_kpt_json_path = os.path.join(root_eartype, "5_test_json")
                create_dataset([name], test_kpt_img_path, test_kpt_json_path, root_eartype, degrees, ear_type, use_bbox = False, dataset_type = "test")
