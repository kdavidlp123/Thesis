...
#     '../_base_/datasets/ear_detection.py',
...
# val_evaluator = dict(
#     type='CocoMetric',
#     ann_file=data_root + 'new_test_json/test.json',
#     metric='bbox',
#     backend_args=backend_args)
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='testing_json/testing.json',
        data_prefix=dict(img='testing/'),
        test_mode=True,
        pipeline=test_pipeline,
        backend_args=backend_args,
        ))
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'testing_json/testing.json',
    metric='bbox',
    backend_args=backend_args)
test_evaluator = val_evaluator
